param(
    [ValidateSet('art', 'pathing', 'nora-routing', 'hours', 'animations', 'animation-journeys', 'waterfront', 'ship', 'life', 'projects', 'c0', 'first-opening', 'intro', 'holger', 'first-days', 'home', 'visitors', 'bookshelf', 'cat-corner')]
    [string[]]$Suite = @('art', 'pathing', 'nora-routing', 'hours', 'animations', 'animation-journeys', 'waterfront', 'ship', 'life', 'projects', 'c0', 'first-opening', 'intro', 'holger', 'first-days', 'home', 'visitors', 'bookshelf', 'cat-corner'),
