param(
    [ValidateSet('art', 'pathing', 'nora-routing', 'hours', 'animations', 'cat-animations', 'animation-journeys', 'waterfront', 'ship', 'life', 'projects', 'c0', 'first-opening', 'intro', 'holger', 'first-days', 'home', 'visitors', 'bookshelf', 'cat-corner', 'invitations', 'gerda')]
    [string[]]$Suite = @('art', 'pathing', 'nora-routing', 'hours', 'animations', 'cat-animations', 'animation-journeys', 'waterfront', 'ship', 'life', 'projects', 'c0', 'first-opening', 'intro', 'holger', 'first-days', 'home', 'visitors', 'bookshelf', 'cat-corner', 'invitations', 'gerda'),
