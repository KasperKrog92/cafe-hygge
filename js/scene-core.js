...
(function () {
  ...
  const L = (SCENE.L = {
    W: W, H: H,
    home: {
      wallY: 266, floorBottom: 550, lane: 350,
      // Full-height rear walls, cutaway sides/fronts. Fixture baselines include
      // their projected depth from the rear wall; doorways stay clear beside them.
      kitchen: {
    ...
    intro: {
      signStored: {x:98,y:245}, signPickup: {x:98,y:262},
    ...
    // Counter task lights: y is the shade's lower rim. Cords continue to
    // the unseen ceiling; both shades clear the back-bar shelves and menu.
    pendants: [{ x: 714, y: 78 }, { x: 866, y: 78 }],
